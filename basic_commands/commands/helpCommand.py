...
class HelpCommand:
    ...
    async def help(self, ctx: Context):
        ...
        embed.add_field(
            name='$$remove-moeny <число> [@mention]',
        ...
        # )
        embed.add_field(
            name='$$block ^reply | @mention',
            value='Заблокировать пользователя. Его пинги перестанут до вас доходить. Команда доступна всем',
            inline=False
        )
        embed.add_field(
            name='$$unblock ^reply | @mention',
            value='Разблокировать пользователя. Его пинги начнут до вас доходить. Команда доступна всем',
            inline=False
        )
        embed.set_footer(
